...
import com.btp.guessed.Adapter.AnswerSheetAdapter;
import com.btp.guessed.Adapter.AnswerSheetHelperAdapter;
import com.btp.guessed.Adapter.QuestionFragmentAdapter;
import com.btp.guessed.Adapter.ResultGridAdapter;
...
import com.btp.guessed.DBHelper.OnlineDBHelper;
import com.btp.guessed.Interface.MyCallback;
import com.btp.guessed.Misc.CustomViewPager;
import com.btp.guessed.model.CurrentQuestion;
import com.btp.guessed.model.Question;
...
*/
                MaterialDialog mDialog = new MaterialDialog.Builder(QuestionActivity.this)
                        .setTitle("Finish?")
                        .setMessage("Do you really want to finish?")
                        .setPositiveButton("Yes", R.drawable.fui_done_check_mark, (dialogInterface, which) -> {
                            dialogInterface.dismiss();
                            finishGame();
                            drawer.closeDrawer(GravityCompat.START);
                        })
                        .setNegativeButton("No", R.drawable.ic_clear_white_24dp, (dialogInterface, which) -> dialogInterface.dismiss())
                        .build();
                mDialog.show();
            }
            else
        ...
        if(!Common.isOnlineMode)
        {
            ...
            if(Common.questionList.size() == 0)
            {
                ...
                MaterialDialog mDialog = new MaterialDialog.Builder(this)
                        .setTitle("Oops!")
                        .setMessage("We don't have any question in "+Common.selectedCategory.getName()+" category ")
                        .setPositiveButton("OK", R.drawable.ic_sentiment_very_dissatisfied_black_24dp, (dialogInterface, which) -> {
                            dialogInterface.dismiss();
                            finish();
                        })
                        .build();
...
//                        Toast.makeText(QuestionActivity.this, "position(get(0)) = "+position, Toast.LENGTH_SHORT).show();
    ...
    public boolean onPrepareOptionsMenu(Menu menu)
    {
        ...
        MaterialDialog mDialog = new MaterialDialog.Builder(this)
                .setTitle("Warning!")
                .setMessage("You can only swipe right.\nOnce you swipe right, you won't be able to go back left.\n\nHappy Quizzing!")
                .setPositiveButton("OK", R.drawable.ic_error_outline_black_24dp, (dialogInterface, which) -> dialogInterface.dismiss())
                .build();
        mDialog.show();
...
//                            btn_sign_out.setEnabled(false);
                        startActivity(new Intent(QuestionActivity.this, MainActivity.class));
                    }).addOnFailureListener(e -> Toast.makeText(QuestionActivity.this, ""+e.getMessage(), Toast.LENGTH_SHORT).show());
        }
